<?php /* Smarty version Smarty-3.1.14, created on 2013-08-25 04:30:52
         compiled from "./templates/trackmyitem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204651330052161b06906ee8-40597759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a5d9d6dce4d75d90532da29b8e008460ded4948' => 
    array (
      0 => './templates/trackmyitem.tpl',
      1 => 1377419451,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '204651330052161b06906ee8-40597759',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52161b0695c001_95417507',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52161b0695c001_95417507')) {function content_52161b0695c001_95417507($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	$(document).ready(function() {
		...
		function showSearchHistory(type) {
			...
			$('#search_history').find('a[data-node="editlabel"]').click(function(){
				...
				if(label.length == 0)
					label = window.prompt("提示", "请输入此订单号的备注");
				else
